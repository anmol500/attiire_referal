...
class WeekOrder extends StatefulWidget {
  const WeekOrder({required this.database});
  final AppDb database;

  @override
  _WeekOrderState createState() => _WeekOrderState();
}

class _WeekOrderState extends State<WeekOrder> {
  var lastWeeks = Jiffy().subtract(days: 7).startOf(Units.DAY);

  @override
  Widget build(BuildContext context) {
    print(lastWeeks.dateTime);
    return Column(
                    ...
                    children: [
                      StreamBuilder(
                        stream: widget.database
                            .getOrderpFromTo(lastWeeks.dateTime, DateTime.now())
                            .watch(),
